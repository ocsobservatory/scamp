...
Json_write(char *filename)
{
    ...
    json_object_object_add(main_obj, "AstroInstru", astr_instru_array);
    ...
    json_object_object_add(main_obj, "PhotInstru", phot_instru_array);
    ...
    json_object_object_add(tables, "Configuration", conf_array);
